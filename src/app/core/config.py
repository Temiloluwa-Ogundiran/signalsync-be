...
class Settings(BaseSettings):
    ...
    MT5_CORE_SYNC_POLL_INTERVAL_SECONDS: float = 0.1
    MT5_CORE_SYNC_WORKER_WAIT_TIMEOUT_SECONDS: int = 240
    MT5_CORE_FAST_VERIFY_TIMEOUT_SECONDS: int = 20
    ...
    COPY_TRADING_METAAPI_ENABLED: bool = False
    METAAPI_TOKEN: str = ""
    METAAPI_REGION: str = "london"
    METAAPI_ACCOUNT_TYPE: str = "cloud-g2"
    METAAPI_CONNECTION_TIMEOUT_SECONDS: int = 120
    METAAPI_PROVISIONING_POLL_SECONDS: int = 60
    METAAPI_PROVISIONING_MAX_ATTEMPTS: int = 15
    METAAPI_IDLE_CONNECTION_SECONDS: int = 300
    METAAPI_RECONNECT_BACKOFF_SECONDS: int = 300
